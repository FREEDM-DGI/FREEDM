...
///////////////////////////////////////////////////////////////////////////////
CDevicePSCAD::CDevicePSCAD(CLineClient::TPointer client,
    CPhysicalDeviceManager& phymanager, Identifier deviceid)
    : m_client(client), IPhysicalDevice(phymanager, deviceid,physicaldevices::FREEDM_GENERIC) 
{};
...
///////////////////////////////////////////////////////////////////////////////
CDevicePSCAD::SettingValue CDevicePSCAD::Get(SettingKey key)
{
    std::string response = m_client->Get(GetID(), key);
...
///////////////////////////////////////////////////////////////////////////////
void CDevicePSCAD::Set(SettingKey key, SettingValue value)
{
    std::string valueInString = boost::lexical_cast<std::string>(value);
    m_client->Set(GetID(), key, valueInString);
};
