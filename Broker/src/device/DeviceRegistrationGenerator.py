...
hppTemplate = open('../../include/device/PhysicalDeviceTypes.hpp.txt', 'r')
cppTemplate = open('PhysicalDeviceTypes.cpp.txt', 'r')

# the files to be generated
hppSource = open('../../include/device/PhysicalDeviceTypes.hpp', 'w')
cppSource = open('PhysicalDeviceTypes.cpp', 'w')

# get our list of devices
devices = glob.glob('../../include/device/types/CDevice*.hpp')
