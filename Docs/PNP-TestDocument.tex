...
\begin{longtable}{|p{3cm}|p{4cm}|p{10cm}|c|}
    ...
    Configuration7 & Run the DGI with a large number of plug and play ports. & 16383 adapter port(s) available. & \\
    ...
    BasicOperation1 & Detect a single plug and play controller. & SST (0) $\rightarrow$ 0.0 \newline SST (1) $\rightarrow$ 5.0 & \\
