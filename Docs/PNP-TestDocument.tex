...
\begin{longtable}{|p{3cm}|p{4cm}|p{10cm}|c|}
    ...
    MultipleControllers8 & Have insufficient port numbers to accept all controllers. & Rejected client: No available port numbers for new adapter. & \\
    MultipleControllers9 & Have insufficient port numbers but have controller timeout. & SST (0) $\rightarrow$ 0.0 \newline \ldots \newline SST (1) $\rightarrow$ 5.0 \newline \ldots \newline SST (1) $\rightarrow$ 7.0 & \\
