# -*- coding: utf-8 -*-
#
# FREEDM documentation build configuration file, created by
...
latex_documents = [
  ('index', 'FREEDM.tex', u'FREEDM Documentation',
   u'S\\&T DGI Team', 'manual'),
]
...
man_pages = [
    ('index', 'freedm', u'FREEDM Documentation',
     [u'S&T DGI Team'], 1)
]
...
texinfo_documents = [
  ('index', 'FREEDM', u'FREEDM Documentation',
   u'S&T DGI Team', 'FREEDM', 'One line description of project.',
   'Miscellaneous'),
]
